DROP PROCEDURE InsertAttendant
SET ANSI_NULLS ON
GO
...
(000, '5/27/2017', '', (SELECT regionID FROM Regions WHERE regionName = 'Canada/US'))
...
EXECUTE	 InsertAttendant 'Allan Hirt'
EXECUTE	 InsertAttendant 'SQLSatruday 364'
...
INSERT INTO Presentations(title, presenterID, levelID, eventID, trackID) VALUES ('A dive into Data Quality Services', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Steve Simon', 1, CHARINDEX(' ', 'Steve Simon') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Steve Simon'), 1, CHARINDEX(' ', REVERSE('Steve Simon')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'), 1)
INSERT INTO Presentations(title, presenterID, levelID, eventID, trackID) VALUES ('A Dynamic World Demands Dynamic SQL', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Jeremiah Peschka', 1, CHARINDEX(' ', 'Jeremiah Peschka') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Jeremiah Peschka'), 1, CHARINDEX(' ', REVERSE('Jeremiah Peschka')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'), 1)
INSERT INTO Presentations(title, presenterID, levelID, eventID, trackID) VALUES ('A Dynamic World Demands Dynamic SQL', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Jeremiah Peschka', 1, CHARINDEX(' ', 'Jeremiah Peschka') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Jeremiah Peschka'), 1, CHARINDEX(' ', REVERSE('Jeremiah Peschka')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'), 3)
INSERT INTO Presentations(title, presenterID, levelID, eventID, trackID) VALUES ('Absolute Introductory Session on SQL Server 2014 In-Memory Optimized Databases (Hekaton)', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Kevin Goff', 1, CHARINDEX(' ', 'Kevin Goff') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Kevin Goff'), 1, CHARINDEX(' ', REVERSE('Kevin Goff')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'Budapest'), 2)
INSERT INTO Presentations(title, presenterID, levelID, eventID, trackID) VALUES ('AlwaysOn: Improve reliability and reporting performance with one cool tech', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Chris Seferlis', 1, CHARINDEX(' ', 'Chris Seferlis') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Chris Seferlis'), 1, CHARINDEX(' ', REVERSE('Chris Seferlis')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'), 2)
INSERT INTO Presentations(title, presenterID, levelID, eventID, trackID) VALUES ('An introduction to Data Mining', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Steve Simon', 1, CHARINDEX(' ', 'Steve Simon') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Steve Simon'), 1, CHARINDEX(' ', REVERSE('Steve Simon')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'), 3)
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('An Introduction to Database Design', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Mohammad Yusuf', 1, CHARINDEX(' ', 'Mohammad Yusuf') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Mohammad Yusuf'), 1, CHARINDEX(' ', REVERSE('Mohammad Yusuf')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Autogenerating a process data warehouse', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Kennie Pontoppidan', 1, CHARINDEX(' ', 'Kennie Pontoppidan') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Kennie Pontoppidan'), 1, CHARINDEX(' ', REVERSE('Kennie Pontoppidan')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Advanced'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Automate your daily checklist with PBM and CMS', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('John Sterrett', 1, CHARINDEX(' ', 'John Sterrett') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('John Sterrett'), 1, CHARINDEX(' ', REVERSE('John Sterrett')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Budapest'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Automated Installing and Configuration of SQL2014/SQL2012 AlwaysOn Across Multiple Datacenters', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Thomas Grohser', 1, CHARINDEX(' ', 'Thomas Grohser') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Thomas Grohser'), 1, CHARINDEX(' ', REVERSE('Thomas Grohser')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Automated Installing and Configuration of SQL2014/SQL2012 AlwaysOn Across Multiple Datacenters', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Thomas Grohser', 1, CHARINDEX(' ', 'Thomas Grohser') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Thomas Grohser'), 1, CHARINDEX(' ', REVERSE('Thomas Grohser')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Automating Execution Plan Analysis', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Joe Chang', 1, CHARINDEX(' ', 'Joe Chang') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Joe Chang'), 1, CHARINDEX(' ', REVERSE('Joe Chang')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Advanced'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Automating Execution Plan Analysis', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Joe Chang', 1, CHARINDEX(' ', 'Joe Chang') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Joe Chang'), 1, CHARINDEX(' ', REVERSE('Joe Chang')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Advanced'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Automating SQL Server using PowerShell', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Michael Wharton', 1, CHARINDEX(' ', 'Michael Wharton') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Michael Wharton'), 1, CHARINDEX(' ', REVERSE('Michael Wharton')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Balanced Scorecards using SSRS', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Sunil Kadimdiwan', 1, CHARINDEX(' ', 'Sunil Kadimdiwan') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Sunil Kadimdiwan'), 1, CHARINDEX(' ', REVERSE('Sunil Kadimdiwan')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Budapest'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Baselines and Performance Monitoring with PAL', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Mike Walsh', 1, CHARINDEX(' ', 'Mike Walsh') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Mike Walsh'), 1, CHARINDEX(' ', REVERSE('Mike Walsh')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Best Practices Document', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Paresh Motiwala', 1, CHARINDEX(' ', 'Paresh Motiwala') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Paresh Motiwala'), 1, CHARINDEX(' ', REVERSE('Paresh Motiwala')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Best Practices for Efficient SSRS Report Creation', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Mickey Stuewe', 1, CHARINDEX(' ', 'Mickey Stuewe') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Mickey Stuewe'), 1, CHARINDEX(' ', REVERSE('Mickey Stuewe')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Building a BI Solution in the Cloud', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Stacia Misner', 1, CHARINDEX(' ', 'Stacia Misner') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Stacia Misner'), 1, CHARINDEX(' ', REVERSE('Stacia Misner')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Budapest'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Building an Effective Data Warehouse Architecture with the cloud and MPP', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('James Serra', 1, CHARINDEX(' ', 'James Serra') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('James Serra'), 1, CHARINDEX(' ', REVERSE('James Serra')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Bulk load and minimal logged inserts', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Steve Simon', 1, CHARINDEX(' ', 'Steve Simon') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Steve Simon'), 1, CHARINDEX(' ', REVERSE('Steve Simon')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Advanced'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Business Analytics with SQL Server & Power Map:Everything you want to know but were afraid to ask', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Steve Simon', 1, CHARINDEX(' ', 'Steve Simon') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Steve Simon'), 1, CHARINDEX(' ', REVERSE('Steve Simon')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Challenges to designing financial warehouses, lessons learnt', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Kevin Goff', 1, CHARINDEX(' ', 'Kevin Goff') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Kevin Goff'), 1, CHARINDEX(' ', REVERSE('Kevin Goff')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Change Data Capture in SQL Server 2008/2012', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Mickey Stuewe', 1, CHARINDEX(' ', 'Mickey Stuewe') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Mickey Stuewe'), 1, CHARINDEX(' ', REVERSE('Mickey Stuewe')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Changing Your Habits to Improve the Performance of Your T-SQL', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Allan Hirt', 1, CHARINDEX(' ', 'Allan Hirt') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Allan Hirt'), 1, CHARINDEX(' ', REVERSE('Allan Hirt')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Clusters Your Way: #SANLess Clusters for Physical, Virtual, and Cloud Environments', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Allan Hirt', 1, CHARINDEX(' ', 'Allan Hirt') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Allan Hirt'), 1, CHARINDEX(' ', REVERSE('Allan Hirt')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Clusters Your Way: #SANLess Clusters for Physical, Virtual, and Cloud Environments', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('SQLSatruday 364', 1, CHARINDEX(' ', 'SQLSatruday 364') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('SQLSatruday 364'), 1, CHARINDEX(' ', REVERSE('SQLSatruday 364')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Non-Technical'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Coffee Break', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Robert Pearl', 1, CHARINDEX(' ', 'Robert Pearl') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Robert Pearl'), 1, CHARINDEX(' ', REVERSE('Robert Pearl')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Non-Technical'), (SELECT eventID FROM Events WHERE eventName LIKE 'Budapest'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Creating A Performance Health Repository - using MDW', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Steve Simon', 1, CHARINDEX(' ', 'Steve Simon') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Steve Simon'), 1, CHARINDEX(' ', REVERSE('Steve Simon')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Creating efficient and effective SSRS BI Solutions', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Steve Simon', 1, CHARINDEX(' ', 'Steve Simon') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Steve Simon'), 1, CHARINDEX(' ', REVERSE('Steve Simon')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Database Design: Solving Problems Before they Start!', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Mohammad Yusuf', 1, CHARINDEX(' ', 'Mohammad Yusuf') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Mohammad Yusuf'), 1, CHARINDEX(' ', REVERSE('Mohammad Yusuf')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Database Modeling and Design', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Michael Corey', 1, CHARINDEX(' ', 'Michael Corey') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Michael Corey'), 1, CHARINDEX(' ', REVERSE('Michael Corey')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Development Lifecycle with SQL Server Data Tools and DACFx', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Allan Hirt', 1, CHARINDEX(' ', 'Allan Hirt') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Allan Hirt'), 1, CHARINDEX(' ', REVERSE('Allan Hirt')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Did You Vote Today? A DBAs Guide to Cluster Quorum', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Jason Horner', 1, CHARINDEX(' ', 'Jason Horner') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Jason Horner'), 1, CHARINDEX(' ', REVERSE('Jason Horner')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Advanced'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Dimensional Modeling Design Patterns: Beyond Basics', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Jason Horner', 1, CHARINDEX(' ', 'Jason Horner') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Jason Horner'), 1, CHARINDEX(' ', REVERSE('Jason Horner')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Dimensional Modeling Design Patterns: Beyond Basics', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Edward Pollack', 1, CHARINDEX(' ', 'Edward Pollack') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Edward Pollack'), 1, CHARINDEX(' ', REVERSE('Edward Pollack')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Budapest'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Dynamic SQL: Writing Efficient Queries on the Fly', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Brent Ozar', 1, CHARINDEX(' ', 'Brent Ozar') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Brent Ozar'), 1, CHARINDEX(' ', REVERSE('Brent Ozar')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Easy Architecture Design for HA and DR', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('James Serra', 1, CHARINDEX(' ', 'James Serra') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('James Serra'), 1, CHARINDEX(' ', REVERSE('James Serra')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Enhancing your career: Building your personal brand', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Thomas Grohser', 1, CHARINDEX(' ', 'Thomas Grohser') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Thomas Grohser'), 1, CHARINDEX(' ', REVERSE('Thomas Grohser')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Establishing a SLA', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Paul Rizza', 1, CHARINDEX(' ', 'Paul Rizza') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Paul Rizza'), 1, CHARINDEX(' ', REVERSE('Paul Rizza')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('ETL not ELT! Common mistakes and misconceptions about SSIS', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('SQLSaturday 364', 1, CHARINDEX(' ', 'SQLSaturday 364') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('SQLSaturday 364'), 1, CHARINDEX(' ', REVERSE('SQLSaturday 364')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Advanced'), (SELECT eventID FROM Events WHERE eventName LIKE 'Budapest'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Event Kickoff and Networking', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Grant Fritchey', 1, CHARINDEX(' ', 'Grant Fritchey') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Grant Fritchey'), 1, CHARINDEX(' ', REVERSE('Grant Fritchey')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Non-Technical'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Execution Plans: What Can You Do With Them?', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Sayed Saeed', 1, CHARINDEX(' ', 'Sayed Saeed') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Sayed Saeed'), 1, CHARINDEX(' ', REVERSE('Sayed Saeed')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Full Text Indexing Basics', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Steve Simon', 1, CHARINDEX(' ', 'Steve Simon') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Steve Simon'), 1, CHARINDEX(' ', REVERSE('Steve Simon')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'Budapest'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Hacking Exposé - Using SSL to Protect SQL Connections', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Andy Leonard', 1, CHARINDEX(' ', 'Andy Leonard') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Andy Leonard'), 1, CHARINDEX(' ', REVERSE('Andy Leonard')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Hidden in plain sight: master your tools', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('David Bermingham', 1, CHARINDEX(' ', 'David Bermingham') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('David Bermingham'), 1, CHARINDEX(' ', REVERSE('David Bermingham')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Highly Available SQL Server in Windows Azure IaaS', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('James Serra', 1, CHARINDEX(' ', 'James Serra') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('James Serra'), 1, CHARINDEX(' ', REVERSE('James Serra')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('How to Make a LOT More Money as a Consultant', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Brent Ozar', 1, CHARINDEX(' ', 'Brent Ozar') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Brent Ozar'), 1, CHARINDEX(' ', REVERSE('Brent Ozar')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Hybrid Solutions: The Future of SQL Server Disaster Recovery', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Kevin Goff', 1, CHARINDEX(' ', 'Kevin Goff') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Kevin Goff'), 1, CHARINDEX(' ', REVERSE('Kevin Goff')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Budapest'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Implementing Data Warehouse Patterns with the Microsoft BI Tools', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Jack Corbett', 1, CHARINDEX(' ', 'Jack Corbett') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Jack Corbett'), 1, CHARINDEX(' ', REVERSE('Jack Corbett')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Budapest'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Inroduction to Triggers', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Kevin Goff', 1, CHARINDEX(' ', 'Kevin Goff') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Kevin Goff'), 1, CHARINDEX(' ', REVERSE('Kevin Goff')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'Budapest'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Integrating Reporting Services with SharePoint', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Stacia Misner', 1, CHARINDEX(' ', 'Stacia Misner') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Stacia Misner'), 1, CHARINDEX(' ', REVERSE('Stacia Misner')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Integration Services (SSIS) for the DBA', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('John Flannery', 1, CHARINDEX(' ', 'John Flannery') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('John Flannery'), 1, CHARINDEX(' ', REVERSE('John Flannery')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Introduction to Database Recovery', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('John Sterrett', 1, CHARINDEX(' ', 'John Sterrett') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('John Sterrett'), 1, CHARINDEX(' ', REVERSE('John Sterrett')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Introduction to SQL Server - Part 2', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Jeremiah Peschka', 1, CHARINDEX(' ', 'Jeremiah Peschka') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Jeremiah Peschka'), 1, CHARINDEX(' ', REVERSE('Jeremiah Peschka')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Leaving the Windows Open', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('SQLSaturday 364', 1, CHARINDEX(' ', 'SQLSaturday 364') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('SQLSaturday 364'), 1, CHARINDEX(' ', REVERSE('SQLSaturday 364')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Lunchtime Keynote', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Steve Simon', 1, CHARINDEX(' ', 'Steve Simon') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Steve Simon'), 1, CHARINDEX(' ', REVERSE('Steve Simon')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Non-Technical'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Master Data Services Best Practices', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Steve Simon', 1, CHARINDEX(' ', 'Steve Simon') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Steve Simon'), 1, CHARINDEX(' ', REVERSE('Steve Simon')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Master Data Services Disaster Recovery', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('James Serra', 1, CHARINDEX(' ', 'James Serra') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('James Serra'), 1, CHARINDEX(' ', REVERSE('James Serra')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Mind your language!! Cursors are a dirty word', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Steve Simon', 1, CHARINDEX(' ', 'Steve Simon') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Steve Simon'), 1, CHARINDEX(' ', REVERSE('Steve Simon')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Modern Data Warehousing', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Hilary Cotter', 1, CHARINDEX(' ', 'Hilary Cotter') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Hilary Cotter'), 1, CHARINDEX(' ', REVERSE('Hilary Cotter')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Monitoring Server health via Reporting Services dashboards', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Stacia Misner', 1, CHARINDEX(' ', 'Stacia Misner') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Stacia Misner'), 1, CHARINDEX(' ', REVERSE('Stacia Misner')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Monitoring SQL Server using Extended Events', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Jason Brimhall', 1, CHARINDEX(' ', 'Jason Brimhall') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Jason Brimhall'), 1, CHARINDEX(' ', REVERSE('Jason Brimhall')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Multidimensional vs Tabular - May the Best Model Win', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Mike Walsh', 1, CHARINDEX(' ', 'Mike Walsh') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Mike Walsh'), 1, CHARINDEX(' ', REVERSE('Mike Walsh')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Never Have to Say "Mayday!!!" Again', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Kevin Schenega', 1, CHARINDEX(' ', 'Kevin Schenega') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Kevin Schenega'), 1, CHARINDEX(' ', REVERSE('Kevin Schenega')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'New York'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Optimizing Protected Indexes', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Todd Chittenden', 1, CHARINDEX(' ', 'Todd Chittenden') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Todd Chittenden'), 1, CHARINDEX(' ', REVERSE('Todd Chittenden')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Budapest'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('PowerShell for the Reluctant DBA / Developer', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Edward Pollack', 1, CHARINDEX(' ', 'Edward Pollack') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Edward Pollack'), 1, CHARINDEX(' ', REVERSE('Edward Pollack')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Reporting Services for Mere DBAs', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Hilary Cotter', 1, CHARINDEX(' ', 'Hilary Cotter') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Hilary Cotter'), 1, CHARINDEX(' ', REVERSE('Hilary Cotter')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Self-Service Data Integration with Power Query', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Allan Hirt', 1, CHARINDEX(' ', 'Allan Hirt') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Allan Hirt'), 1, CHARINDEX(' ', REVERSE('Allan Hirt')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Shortcuts to Building SSIS in .Net', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Kennie Pontoppidan', 1, CHARINDEX(' ', 'Kennie Pontoppidan') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Kennie Pontoppidan'), 1, CHARINDEX(' ', REVERSE('Kennie Pontoppidan')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('So You Want To Be A Consultant?', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Kevin Goff', 1, CHARINDEX(' ', 'Kevin Goff') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Kevin Goff'), 1, CHARINDEX(' ', REVERSE('Kevin Goff')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('SQL anti patterns', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('George Walters', 1, CHARINDEX(' ', 'George Walters') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('George Walters'), 1, CHARINDEX(' ', REVERSE('George Walters')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Advanced'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('SQL Server 2012/2014 Performance Tuning All Up', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('George Walters', 1, CHARINDEX(' ', 'George Walters') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('George Walters'), 1, CHARINDEX(' ', REVERSE('George Walters')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('SQL Server 2014 Data Access Layers', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('George Walters', 1, CHARINDEX(' ', 'George Walters') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('George Walters'), 1, CHARINDEX(' ', REVERSE('George Walters')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('SQL Server 2014 New Features', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Jason Brimhall', 1, CHARINDEX(' ', 'Jason Brimhall') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Jason Brimhall'), 1, CHARINDEX(' ', REVERSE('Jason Brimhall')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('SQL Server Compression and what it can do for you', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Kevin Goff', 1, CHARINDEX(' ', 'Kevin Goff') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Kevin Goff'), 1, CHARINDEX(' ', REVERSE('Kevin Goff')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Advanced'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('SQL Server Reporting Services 2014 on Steroids!!', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Thomas Grohser', 1, CHARINDEX(' ', 'Thomas Grohser') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Thomas Grohser'), 1, CHARINDEX(' ', REVERSE('Thomas Grohser')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('SQL Server Reporting Services Best Practices', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Brandon Leach', 1, CHARINDEX(' ', 'Brandon Leach') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Brandon Leach'), 1, CHARINDEX(' ', REVERSE('Brandon Leach')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('SQL Server Storage Engine under the hood', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Carl Berglund', 1, CHARINDEX(' ', 'Carl Berglund') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Carl Berglund'), 1, CHARINDEX(' ', REVERSE('Carl Berglund')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('SQL Server Storage internals: Looking under the hood.', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Hilary Cotter', 1, CHARINDEX(' ', 'Hilary Cotter') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Hilary Cotter'), 1, CHARINDEX(' ', REVERSE('Hilary Cotter')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Advanced'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Stress testing SQL Server', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Adam Jorgensen', 1, CHARINDEX(' ', 'Adam Jorgensen') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Adam Jorgensen'), 1, CHARINDEX(' ', REVERSE('Adam Jorgensen')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Advanced'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Table partitioning for Azure SQL Databases', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Dennis Messina', 1, CHARINDEX(' ', 'Dennis Messina') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Dennis Messina'), 1, CHARINDEX(' ', REVERSE('Dennis Messina')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('The future of the data professional', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Chris Bell', 1, CHARINDEX(' ', 'Chris Bell') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Chris Bell'), 1, CHARINDEX(' ', REVERSE('Chris Bell')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'Kiyv'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('The Quest to Find Bad Data With Data Profiling', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Aaron Bertrand', 1, CHARINDEX(' ', 'Aaron Bertrand') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Aaron Bertrand'), 1, CHARINDEX(' ', REVERSE('Aaron Bertrand')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Budapest'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('The Spy Who Loathed Me - An Intro to SQL Security', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Greg Moore', 1, CHARINDEX(' ', 'Greg Moore') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Greg Moore'), 1, CHARINDEX(' ', REVERSE('Greg Moore')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'Budapest'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Tired of the CRUD? Automate it!', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Aaron Bertrand', 1, CHARINDEX(' ', 'Aaron Bertrand') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Aaron Bertrand'), 1, CHARINDEX(' ', REVERSE('Aaron Bertrand')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Budapest'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Top 5 Ways to Improve Your triggers', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Kevin Goff', 1, CHARINDEX(' ', 'Kevin Goff') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Kevin Goff'), 1, CHARINDEX(' ', REVERSE('Kevin Goff')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Intermediate'), (SELECT eventID FROM Events WHERE eventName LIKE 'Budapest'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('Using Extended Events in SQL Server', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('James Serra', 1, CHARINDEX(' ', 'James Serra') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('James Serra'), 1, CHARINDEX(' ', REVERSE('James Serra')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Advanced'), (SELECT eventID FROM Events WHERE eventName LIKE 'Budapest'))
INSERT INTO Presentations(title, presenterID, levelID, eventID) VALUES ('What exactly is big data and why should I care?', (SELECT presenterID FROM Presenters WHERE (attendantID = (SELECT attendantID FROM Attendants WHERE firstName = (SUBSTRING('Paresh Motiwala', 1, CHARINDEX(' ', 'Paresh Motiwala') - 1)) AND lastName = (REVERSE(SUBSTRING(REVERSE('Paresh Motiwala'), 1, CHARINDEX(' ', REVERSE('Paresh Motiwala')) - 1)))))),  (SELECT levelID  FROM Levels WHERE levelDifficulty LIKE 'Beginner'), (SELECT eventID FROM Events WHERE eventName LIKE 'Budapest'))
